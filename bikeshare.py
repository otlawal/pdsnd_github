...
def get_filters():
    ...
    city = input('\nWould you like to see data Chicago, New York, or Washington?\n').lower()
    # users to input city here
    ...
    #get user input for month (all, january to june)
    ...
    while(True):
        if(day =='monday' or day == 'tuesday' or day == 'wednesday', day == 'thursday' or day == 'friday' or day == 'saturday' or day == 'sunday' or day == 'all'):
            break
        else:
            day = input('Enter Correct day: ').lower()
            #lower is used to get in any format
...
def time_stats(df, month, day):
    ...
    if (month == 'all'):
       most_commom_month = df['Start Time'].dt.month.value_counts().idmax()
       print('Most common month is '+ str(most_common_month))

    # TO DO: display the most common day of week
    if(day == 'all'):
       most_common_day = df['Start Time'].dt.weekday_name.value_counts().idmax()
